        ...
        return io.Schema(
            ...
            inputs=[
                ...
                io.Combo.Input(
                    ...
                    tooltip="Resize image before inference. FASHN was trained at 384×576 — feeding much larger images blurs class boundaries on upsample. Smaller = sharper edges, less detail.",
                ),
                io.Float.Input(
