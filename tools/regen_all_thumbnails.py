...
CONFIGS = {
    ...
    "BD-parts_builder_2": {
        ...
        "bullets": ["Closed-list vote (Qwen3-VL) -> only present items",
                    ...
                    "Bald -> mouthless / eyeless plates, frame-proven, 1024 or 2048",
                    "Eye / brow / lip socket mask + matte for FaceMaker",
                    "Engine stack + PSD export (BD Parts Export)",
                    "BD Compare Images: red-zone difference vs the source"],
        "chips": ["Qwen 2.1", "RGBA", "PSD", "masks", "compare"]},
    ...
    "BD-autorig_mia_uefn_full": {
        "title": "AutoRig: Full UEFN Pipeline", "subtitle": "Mesh → rig → UEFN skeleton + preview",
        "bullets": ["BD AutoRig MIA — ML Mixamo rigging (<1s GPU)",
                    "BD AutoRig UEFN — Blender weight transfer → genuine UEFN skeleton",
                    "BD Preview 3D — interactive ComfyUI 3D viewer",
                    "BD Rig Preview — headless EEVEE 4-view bone visualization",
                    "Output FBX importable directly into UEFN / Fortnite"],
        "chips": ["MIA", "UEFN", "Blender", "Preview3D"]},
    "BD-autorig_hymotion": {
